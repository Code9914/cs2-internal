...
void LoadConfig() {
    ...
    int b = 1, bf = 0, bc = 0, hp = 1, nm = 1, dist = 0, esp = 1, wm = 1;
    int ae = 0, tc = 1, af = 0, sf = 0, sa = 0;
...
void SaveConfig() {
    ...
    fprintf_s(f, "%d %d %d %d %d %d %d %d"
        ...
        settings::aimbotShowFov, settings::silentAim, settings::aimbotFov, settings::aimbotSmooth);
    fclose(f);
}
